...
export default function SignUpPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-900 via-teal-800 to-emerald-950 p-12 flex-col justify-between relative overflow-hidden">
        {/* Background pattern */}
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3">
            <Image
              src="https://www.sicgil.com/img/logo.png"
              alt="Sicgil Logo"
              width={48}
              height={48}
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-left">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Get started with your AI-powered QA automation platform today.
            </p>
          </div>
